...
export const DashboardMainSuccess = createAction(DashBoardTypes.DASHBOARD_MAIN_SUCCESS);
export const DashboardMainFailed = createAction(DashBoardTypes.DASHBOARD_MAIN_FAILURE);
...
export const DashboardMonthlySuccess = createAction(DashBoardTypes.DASHBOARD_MONTHLY_SUCCESS);
export const DashboardMonthlyFailed = createAction(DashBoardTypes.DASHBOARD_MONTHLY_FAILURE);
