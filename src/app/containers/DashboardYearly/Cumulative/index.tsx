...
const data = months.map((month: string) => ({
  ...
  data: [
    ...
    {
      // label: "BUD",
      value: <div className="icon-col"><i className='fa fa-arrow-up text-success' aria-hidden='true'></i></div>,
    },
    {
      // label: "LY",
      value: (
        <div className="icon-col" ><i className='fa fa-arrow-down text-danger' aria-hidden='true'></i></div>
      ),
    },
  ],
}));
                                  ...
                                  <PieChartComponent
                                    ...
                                    chartSettings={{
                                      SeriesDirective : {
                                          ...
                                          explodeIndex: 0,
                                          radius: "70%",
                                          palettes: ['#5b9cd6', '#ed7d31', '#a5a5a5', '#ffbf00']
                                  },
                                      chartComponent: {
