            ...
            <Table responsive className="pickup-detail-table mb-0">
              <thead>
                ...
                <tr>
                  ...
                  <th className="head-col left-width bob-head-col">Rooms</th>
                  <th className="head-col  bob-head-col">ADR</th>
                  <th className="head-col bob-head-col">Revenue</th>
                  <th className="head-col left-width bob-head-col">Rooms</th>
                  <th className="head-col bob-head-col">ADR</th>
                  <th className="head-col bob-head-col">Revenue</th>
                  <th className="head-col left-width bob-head-col">Rooms</th>
                  <th className="head-col bob-head-col ">ADR</th>
                  <th className="head-col bob-head-col ">Revenue</th>
                  <th className="head-col bob-head-col left-width">Rooms</th>
                  <th className="head-col bob-head-col ">ADR</th>
                  <th className="head-col bob-head-col ">Revenue</th>
                  <th className="head-col bob-head-col left-width">Rooms</th>
                  <th className="head-col bob-head-col ">ADR</th>
                  ...
                  <th className="head-col  bob-head-col ">ADR</th>
                  <th className="head-col bob-head-col ">Revenue</th>
                  <th className="head-col  bob-head-col total-content">Rooms</th>
                  <th className="head-col  bob-head-col ">ADR</th>
                  <th className="head-col bob-head-col ">Revenue</th>
                </tr>
              </thead>
