...
export const CumulativeTableReducer = handleActions<IBookingChannelModel, IBookingChannelModel>(
  {
    ...
    // past
    [CumulativeTableActionTypes.TOGGLE_CUMULATIVE_TABLE_PAST_LOADER]: (
      state = CumulativeTableInitialState,
      action
    ): IBookingChannelModel => ({
      ...state,
    ...
    [CumulativeTableActionTypes.CUMULATIVE_TABLE_PAST_DATA_FAILED]: (
      state = CumulativeTableInitialState,
      action
    ): IBookingChannelModel => ({
      isLoading: false,
    ...
    [CumulativeTableActionTypes.CUMULATIVE_TABLE_PAST_DATA_SUCCESS]: (
      state = CumulativeTableInitialState,
      action
    ): IBookingChannelModel => ({
      isLoading: false,
    ...
    // future
    [CumulativeTableActionTypes.TOGGLE_CUMULATIVE_TABLE_FUTURE_LOADER]: (
      state = CumulativeTableInitialState,
      action
    ): IBookingChannelModel => ({
      ...state,
    ...
    [CumulativeTableActionTypes.CUMULATIVE_TABLE_FUTURE_DATA_FAILED]: (
      state = CumulativeTableInitialState,
      action
    ): IBookingChannelModel => ({
      isLoading: false,
    ...
    [CumulativeTableActionTypes.CUMULATIVE_TABLE_FUTURE_DATA_SUCCESS]: (
      state = CumulativeTableInitialState,
      action
    ): IBookingChannelModel => ({
      isLoading: false,
